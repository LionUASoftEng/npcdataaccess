...
public abstract class BaseModel<T extends BaseModel<T>> {
	...
	public BaseModel<T> setId(UUID id) {
		this.id = id;
		this.onIdSet();
	...
	public void onLoadComplete(String connectionString) {}
	...
	protected BaseModel(BaseRepositoryInterface<T> repository) {
		this((new UUID(0, 0)), repository);
	}
	
	protected BaseModel(UUID id, BaseRepositoryInterface<T> repository) {
		this.isNew = true;
		this.isDirty = true;
